<?php include "header.php" ?>
	...
	<div class="row">
		<div class="img col s12 valign-wrapper center-align" style="height: 340px; overflow:hidden; background: url('stock-images/bg.jpg') no-repeat center 10%">
            <!--<div class="container">
		...
		<div class="row">
			...
			<div class="col s12 m8">
				<div class="card-panel">
					<p class="grey-text text-darken-2">hi! i’m lenin hasda from dhaka, bangladesh and i like doing interesting staff :D <br/> as a professional i'm a (web) programmer and love wordpress a lot. but apart from this i do cycling, drawing , puzzle solving, running, blogging, listen to music, watch anime and definitely hang around with friends <a href="" class="red-text text-lighten-2"><small>. . .<code>[more]</code></small></a></p>
				</div>
			</div>
		</div>
		<div class="row">
